...
export class FormodvenComponent implements OnInit {
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(DialogComponentDataModven, {
      width: '250px',
    });
...
@Component({
  ...
  templateUrl: './DialogModven.html',
})
export class DialogComponentDataModven {
  constructor(
    public dialogRef: MatDialogRef<DialogComponentDataModven>,
